...
public class TestHandlers {
   ...
   */
  @Test
  public void testAPIStateCode(Request request, Response response, String state)
    ...
    if (stateParam != null && countyParam != null) {
      ...
      BroadbandProxy proxyResponseLoS =
          new BroadbandProxy(adapter2.fromJson(sentBoredApiResponse.body()));
  ...
  @Test
  public void testAPIBroadband(Request request, Response response, List<List<String>> stateCode)
      throws URISyntaxException, IOException, InterruptedException {
    if (!stateCode.equals("error_bad_request") && !stateCode.equals("error_not_found")) {
